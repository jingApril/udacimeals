          ...
          >
              <div>
                  {loadingFood === true
                      ...
                      : <div className='search-container'><h3 className="subheader">Find a meal for {capitalize(this.state.day)} {this.state.meat}</h3>
                          ...
                          { food != null && (
                              <FoodList
                                  food={food}
                                  onSelect ={(recipe) => {selectRecipe({ recipe,day: this.state.day, meal: this.state.meal})
                                      this.closeFoodModal()}}/>
                          )}
                      </div> }
              </div>
